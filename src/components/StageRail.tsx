  ...
  const groups = [
    {
      label: "故事基础",
      detail: "世界观、角色与大纲",
      stages: ["world_builder", "character_designer", "plot_planner", "blueprint_review"],
    },
    ...
    { label: "正文写作", detail: "初稿、修订与润色", stages: ["scene_writer", "scene_rewriter", "style_editor"] },
    {
      label: "审校定稿",
      detail: "一致性、人工审查与终审",
      stages: ["consistency_checker", "human_review", "book_auditor"],
    },
  ];
          ...
          return (
            <div className={`stage ${complete ? "complete" : ""} ${active ? "active" : ""}`} key={group.label}>
              ...
              <div>
                ...
                <small>{active ? activeNode : group.detail}</small>
              </div>
